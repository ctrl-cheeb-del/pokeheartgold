...
int ov57_0223B73C(void *p) {
    ov57_0223B828(p, 2, 0, 3);
    return 0;
}

int ov57_0223B74C(void *p) {
    ov57_0223B828(p, 3, 0, 3);
    return 0;
}

void ov57_0223B75C(u8 *p) {
    u32 i = *(u32 *)(p + 0x3EC);
    CopyCapsule(*(void **)(p + i * 8 + 8), p + 0x68);
}

void ov57_0223B774(u8 *p) {
    u32 i = *(u32 *)(p + 0x3EC);
    CopyCapsule(p + 0x68, *(void **)(p + i * 8 + 8));
}
