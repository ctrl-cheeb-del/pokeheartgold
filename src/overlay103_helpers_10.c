...
u32 ov103_021ED550(void *a0) {
    ov103_021EEC78[U32AT(a0, W_BRANCH)].enter(a0);
    return 7;
}

u32 ov103_021ED568(void *a0) {
    if (OverlayManager_Run(PAT(a0, W_OVLMGR)) == 0) {
        return 7;
    }
    OverlayManager_Delete(PAT(a0, W_OVLMGR));
    U32AT(a0, W_STATE) = ov103_021EEC78[U32AT(a0, W_BRANCH)].leave(a0);
    return ov103_021EEC78[U32AT(a0, W_BRANCH)].next;
}

u32 ov103_021ED5A8(void *a0) {
    return ov103_021EDA14(a0, 9);
}
