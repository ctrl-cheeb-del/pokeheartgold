...
void ov10_0221C8D8(void *x, AIState *p) {
    u32 a, b;
    (void)x;
    ov10_0221EF24(p, 1);
    a = ov10_0221EEF0(p);
    b = ov10_0221EEF0(p);
    if (*(u32 *)&p->data[0x35c] == a) {
        ov10_0221EF24(p, b);
    }
}

void ov10_0221C908(void *x, AIState *p) {
    u32 a, b;
    (void)x;
    ov10_0221EF24(p, 1);
    a = ov10_0221EEF0(p);
...
void ov10_0221C938(void *x, AIState *p) {
    u32 a, b;
    (void)x;
    ov10_0221EF24(p, 1);
    a = ov10_0221EEF0(p);
...
void ov10_0221C968(void *x, AIState *p) {
    u32 a, b;
    (void)x;
    ov10_0221EF24(p, 1);
    a = ov10_0221EEF0(p);
