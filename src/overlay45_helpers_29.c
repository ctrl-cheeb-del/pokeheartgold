...
void ov45_0222DCE8(u8 *p) {
    ov45_0222E03C(p + 0x5c);
}

u32 ov45_0222DCF4(u32 *p, u32 *q) {
    *q = p[0];
    return p[1];
}

void ov45_0222DCFC(u8 *p) {
    ov45_0222DECC(p + 8);
}

void ov45_0222DD08(u8 *p) {
    ov45_0222DEE0(p + 8);
}

void ov45_0222DD14(u8 *p) {
    ov45_0222DEF4(p + 8);
}

void ov45_0222DD20(u8 *p) {
    ov45_0222DF14(p + 8);
}

void ov45_0222DD2C(u8 *p) {
    ov45_0222DF58(p + 8);
}

u16 ov45_0222DD38(u8 *p) {
    return ov45_0222DF50(p + 8);
}
