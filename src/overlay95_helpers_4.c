...
void ov95_021E5E40(void *p) {
    void *q = sub_020154D0(p);
    sub_02014EBC(p);
    Heap_Free(q);
}

void ov95_021E5E58(State *p) {
    s32 v[3] = { 0, 0, 0 };
    *(s32 *)((u8 *)p + 0x28) = v[0] + (**(s32 ***)((u8 *)p + 0x20))[1];
    *(s32 *)((u8 *)p + 0x2c) = v[1] + (**(s32 ***)((u8 *)p + 0x20))[2];
    *(s32 *)((u8 *)p + 0x30) = v[2] + (**(s32 ***)((u8 *)p + 0x20))[3];
}
