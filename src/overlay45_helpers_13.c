...
u16 ov45_0222B020(Overlay45State *p) {
    return *(u16 *)&p->data[0x1c4];
}

u8 ov45_0222B028(Overlay45State *p) {
    return p->data[0x1cb];
}

u8 ov45_0222B034(Overlay45State *p) {
    return p->data[0x1c6];
}

u16 ov45_0222B040(Overlay45State *p) {
    return *(u16 *)&p->data[0x1c8];
}
