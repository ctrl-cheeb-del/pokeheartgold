...
void ov64_021E6754(State *p) {
    ManagedSprite_SetDrawFlag(*(void **)((u8 *)p + 0x138), 0);
    ManagedSprite_SetDrawFlag(*(void **)((u8 *)p + 0x13c), 0);
    BgFillTilemapBufferAndSchedule(*(void **)((u8 *)p + 4), 4, 0);
}
