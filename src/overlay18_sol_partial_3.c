#include "overlay18_sol_partial_internal.h"

void ov18_021F1BC8(void *, int, int, int);
u32 ov18_021F2C98(void *, int);
...
void ov18_021F1324(void *, int);
void ov18_021F17FC(void *);
void ov18_021F193C(void *);
void ov18_021F5E0C(void *);
void ov18_021F7018(void *, int);
void ov18_021F719C(void *, int);
void ov18_021F77C0(void *, int);
...
void ov18_021F0F2C(void *p) {
    ClearWindowTilemapAndScheduleTransfer((u8 *)p + 0x0C);
    ClearWindowTilemapAndScheduleTransfer((u8 *)p + 0x3C);
    ClearWindowTilemapAndScheduleTransfer((u8 *)p + 0x5C);
    ClearWindowTilemapAndScheduleTransfer((u8 *)p + 0x8C);
    ClearWindowTilemapAndScheduleTransfer((u8 *)p + 0x9C);
    ClearWindowTilemapAndScheduleTransfer((u8 *)p + 0x6C);
    ClearWindowTilemapAndScheduleTransfer((u8 *)p + 0x7C);
}
