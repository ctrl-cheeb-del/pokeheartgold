...
void ov47_02258A14(State *p) {
    ov47_02258A8C(p);
}

void ov47_02258A1C(State *p, void *save, int heap) {
    void *o = Save_PlayerData_GetOptionsAddr(save);
    *(void **)((u8 *)p + 0x140) = NARC_New(0xD1, heap);
    GF_CreateVramTransferManager(0x20, heap);
    GfGfx_SetBanks(ov47_02259EC0);
    ov47_02258AA0(p, o, heap);
    ov47_02258BB4(p, heap);
}

void ov47_02258A60(State *p) {
    NARC_Delete(*(void **)((u8 *)p + 0x140));
    GF_DestroyVramTransferManager();
    ov47_02258B8C(p);
    ov47_02258C44(p);
}

void ov47_02258A80(State *p) {
    SpriteList_RenderAndAnimateSprites(*(void **)((u8 *)p + 4));
}

void ov47_02258A8C(State *p) {
    DoScheduledBgGpuUpdates(*(void **)p);
