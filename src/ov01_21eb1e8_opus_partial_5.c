...
u16 ov01_021EB804(WeatherSys *sys, int idx) {
    ...
    return sys->recs[idx].unk10;
}

void ov01_021EB818(int a0, int a1) {
    G2x_SetBlendAlpha_(0x04000050, 4, 0x21, a0, a1);
}
...
void ov01_021EB86C(WeatherSys *sys, u16 a1, WeatherGfx *gfx) {
    ov01_021EBEF0(sys, a1, gfx);
    ov01_021EBF24(sys, a1, gfx);
    ov01_021EBF58(sys, a1, gfx);
    ov01_021EBF94(sys, a1, gfx);
}
