...
void ov109_021E5B40(PhotoAlbumApp *app) {
    ov109_021E5D5C(app);
    Heap_Free(app->photos);
    MenuInputStateMgr_SetState(app->args->menuInputStatePtr, (MenuInputState)app->nextMenuState);
}
...
int ov109_021E5BAC(PhotoAlbumApp *app) {
    switch (app->state) {
    case 0:
        BeginNormalPaletteFade(FADE_BOTH_SCREENS, FADE_TYPE_BRIGHTNESS_IN, FADE_TYPE_BRIGHTNESS_IN, 0, 6, 1, app->heapId);
        ++app->state;
        break;
    case 1:
...
int ov109_021E5BF4(PhotoAlbumApp *app) {
    switch (app->state) {
    case 0:
        BeginNormalPaletteFade(FADE_BOTH_SCREENS, FADE_TYPE_BRIGHTNESS_OUT, FADE_TYPE_BRIGHTNESS_OUT, 0, 6, 1, app->heapId);
        ++app->state;
        break;
    case 1:
        if (IsPaletteFadeFinished()) {
...
int ov109_021E5C40(PhotoAlbumApp *app) {
    return ov109_021E5F10(app);
}

int ov109_021E5C48(PhotoAlbumApp *app) {
    if (!ov109_021E656C(app)) {
        return 2;
    }
    if (app->unk_20 == 1) {
        return 5;
...
int ov109_021E5C88(PhotoAlbumApp *app) {
    return ov109_021E681C(app);
}

int ov109_021E5C90(PhotoAlbumApp *app) {
    return ov109_021E61BC(app);
}

int ov109_021E5C98(PhotoAlbumApp *app) {
    if (ov109_021E61DC(app)) {
        return 1;
    }
    return 6;
}
...
void ov109_021E5CB4(PhotoAlbumApp *app) {
    ...
    ov109_021E6D84(app);
    ov109_021E6E9C(app);
    Main_SetVBlankIntrCB((void (*)(void *))ov109_021E685C, app);
}
