...
void ov41_02247578(Ov41Work *w) {
    ov41_0224A54C(AT(w, 0x4e0));
}

void ov41_02247588(Ov41Work *w) {
    ov41_0224A580(AT(w, 0x4e0));
}

void ov41_02247598(void *unused, Ov41Work *w) {
    if (ov41_02248998((Ov41Work *)AT(w, 0x368))) {
        W(w, 0x6b0) = 3;
    }
}

void ov41_022475B4(void *unused, Ov41Work *w) {
    void *r = ov41_0224894C((Ov41Work *)AT(w, 0x368));
    ov41_02248790(AT(w, 0x368), r, 0);
}

void ov41_022475D4(void *unused, Ov41Work *w) {
    void *r = ov41_0224894C((Ov41Work *)AT(w, 0x368));
    ov41_02248790(AT(w, 0x368), r, 1);
}
