...
int ov72_02239E94(u8 *p) {
    *(u32 *)(p + 0x1c) = 0x29;
    return 3;
}

int ov72_02239E9C(u8 *p) {
    Save_PrepareForAsyncWrite(*(void **)(*(u8 **)p + 0xc), 2);
    *(u32 *)(p + 0x1c) = 0x28;
    return 3;
}

int ov72_02239EB4(u8 *p) {
    if (Save_WriteFileAsync(*(void **)(*(u8 **)p + 0xc)) == 2) {
...
int ov72_02239ED4(u8 *p) {
    ov72_0223A350(p, *(void **)(p + 0xbd4), 4, 1, 0xf0f);
    ov72_02238680(p, 0x30, 0x16);
    return 3;
}
