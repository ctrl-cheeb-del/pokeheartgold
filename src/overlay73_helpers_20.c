...
int ov73_021E8BFC(void *p) {
    ov73_021E9FF8(p, PTR(p, 0xbdc), 0x11, 1, 0xf0f);
    ov73_021E83EC(p, 0x30, 1);
    return 3;
}

int ov73_021E8C2C(void *p) {
...
int ov73_021E8C8C(void *p) {
    ov73_021E9FF8(p, PTR(p, 0xbd8), 0xc, 1, 0xf0f);
    ov73_021E83EC(p, 0x30, 0x34);
    return 3;
}
