...
int ov05_0221C8A0(Overlay05State *state) {
    PlaySE(0x71a);
    ManagedSprite_SetDrawFlag(*(void **)&state->data[0x1c8], 1);
    ManagedSprite_SetDrawFlag(*(void **)&state->data[0x1cc], 1);
    ManagedSprite_SetAnim(*(void **)&state->data[0x1c8], 0);
    state->data[0xb81] = 0x20;
    return 1;
}

int ov05_0221C8E0(Overlay05State *state) {
    PlaySE(0x71a);
    ManagedSprite_SetDrawFlag(*(void **)&state->data[0x1c8], 1);
    state->data[0xb81] = 0x40;
    return 1;
}
