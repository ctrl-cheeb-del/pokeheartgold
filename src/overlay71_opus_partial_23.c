...
Ov71Scene *ov71_022494A0(Ov71Ctx *ctx) {
    Ov71Scene *sc = (Ov71Scene *)Heap_Alloc(0x39, 0xa4);
    if (sc != NULL) {
        sc->unk_00 = ctx;
        sc->unk_04 = NULL;
        sc->unk_24 = ov71_02247384(ctx);
        sc->unk_28 = NULL;
        ov71_02249988(&sc->unk_34);
    }
    return sc;
}
...
BOOL ov71_02249500(Ov71Scene *w, u32 *state) {
    if (*state < 2) {
        if (((BOOL (*)(Ov71Scene *, void *))ov71_0224BD7C[*state])(w, &w->unk_04)) {
            *state = *state + 1;
            w->unk_04 = NULL;
        }
        ov71_02249538(w);
