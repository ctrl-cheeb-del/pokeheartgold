...
void ov41_02246328(Ov41Work *w, void *narc, int fileId, BOOL compressed, int id) {
    AddCellOrAnimResObjFromOpenNarc((void *)W(w, 0x50), narc, fileId, compressed, id, 2, 0xe);
}

void ov41_02246344(Ov41Work *w, void *narc, int fileId, BOOL compressed, int id) {
    AddCellOrAnimResObjFromOpenNarc((void *)W(w, 0x54), narc, fileId, compressed, id, 3, 0xe);
}

void ov41_02246360(Ov41Work *w, int id) {
    void *r = SpriteResourceCollection_Find((void *)W(w, 0x48), id);
    DestroySingle2DGfxResObj((void *)W(w, 0x48), r);
}

void ov41_02246374(Ov41Work *w, int id) {
    void *r = SpriteResourceCollection_Find((void *)W(w, 0x4c), id);
    DestroySingle2DGfxResObj((void *)W(w, 0x4c), r);
}

void ov41_02246388(Ov41Work *w, int id) {
    void *r = SpriteResourceCollection_Find((void *)W(w, 0x50), id);
    DestroySingle2DGfxResObj((void *)W(w, 0x50), r);
}

void ov41_0224639C(Ov41Work *w, int id) {
    void *r = SpriteResourceCollection_Find((void *)W(w, 0x54), id);
    DestroySingle2DGfxResObj((void *)W(w, 0x54), r);
}
