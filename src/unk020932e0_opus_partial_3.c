...
void sub_02093B40(UnkStruct_020932E0 *ptr) {
    CreateSpriteResourcesHeader((SpriteResourcesHeader *)ptr->header, 0, 0, 0, 0, -1, -1, 0, 0, (GF_2DGfxResMan *)ptr->resObjMan[0], (GF_2DGfxResMan *)ptr->resObjMan[1], (GF_2DGfxResMan *)ptr->resObjMan[2], (GF_2DGfxResMan *)ptr->resObjMan[3], NULL, NULL);
}
