...
u32 ov103_021EDDE4(void *a0) {
    ...
    ov103_021ED0A0(a0);
    ov103_021ED00C(a0);
    if (U16AT(PAT(a0, W_SUB), S_COUNT) <= 0xa) {
        ov103_021EE0CC(PAT(a0, W_SUB), 0, 0);
        ov103_021EE0CC(PAT(a0, W_SUB), 1, 0);
    }
    ...
    ov103_021EE8A8(a0, 1);
    return ov103_021EDA70(a0, 1, 0x12);
}

u32 ov103_021EDE5C(void *a0) {
    ov103_021EDC68(a0, 9, U16AT(a0, W_ITEM), 0);
    U32AT(a0, W_BRANCH) = 1;
    U32AT(a0, W_STATE) = 6;
    return ov103_021EDA40(a0, 1);
}
