...
void ov28_0225DE98(DowsingMchnAngle *ptr) {
    ptr->unk8 = (ptr->unk4 + ptr->unk0 * 5) / 6;
}

void ov28_0225DEB0(DowsingMchn *ptr) {
    u16 v = ov28_0225DE88(ov28_0225DE64(ptr->unk214, ptr->unk218));
    ptr->slots[0].unk0 = v;
    ptr->slots[1].unk0 = v + 0x12C;
    ptr->slots[2].unk0 = v + 0x78;
    ptr->slots[3].unk0 = v + 0xD8;
    ptr->slots[3].val = 6;
}

void ov28_0225DF04(DowsingMchnAngle *ptr) {
    ptr->unk8 = (ptr->unk4 + ptr->unk0 * 3) / 4;
}

void ov28_0225DF14(DowsingMchn *ptr) {
    u16 a = ov28_0225DE88(ov28_0225DE64(ptr->unk214, ptr->unk218));
    u16 b = ov28_0225DE88(ov28_0225DE78(ptr->unk208, ptr->unk20A));
    ptr->slots[0].unk0 = (u32)(b + a * 3) / 4;
    ptr->slots[1].unk0 = (u32)(b + 0x78 + (a + 0x1E) * 3) / 4;
    ptr->slots[2].unk0 = (u32)(b - 0x87 + (a - 0x24) * 3) / 4;
    ptr->slots[3].unk0 = (u32)(b + 0x5A + (a + 0x5A) * 3) / 4;
    ptr->slots[3].val = 4;
}

void ov28_0225DFA4(DowsingMchnAngle *ptr) {
    ptr->unk8 = (ptr->unk4 + ptr->unk0 * 2) / 3;
}

void ov28_0225DFBC(DowsingMchn *ptr) {
    u16 a = ov28_0225DE88(ov28_0225DE64(ptr->unk214, ptr->unk218));
    u16 b = ov28_0225DE88(ov28_0225DE78(ptr->unk208, ptr->unk20A));
    ptr->slots[0].unk0 = (u32)(b + a * 2) / 3;
    ptr->slots[1].unk0 = (u32)(b + 0x87 + (a + 0x1E) * 2) / 3;
    ptr->slots[2].unk0 = (u32)(b - 0x78 + (a - 0x24) * 2) / 3;
    ptr->slots[3].unk0 = (u32)(b + 0x3C + (a + 0x5A) * 2) / 3;
    ptr->slots[3].val = 3;
}

void ov28_0225E054(DowsingMchnAngle *ptr) {
    ptr->unk8 = (ptr->unk4 + ptr->unk0) / 2;
}

void ov28_0225E060(DowsingMchn *ptr) {
    u16 a = ov28_0225DE88(ov28_0225DE64(ptr->unk214, ptr->unk218));
    u16 b = ov28_0225DE88(ov28_0225DE78(ptr->unk208, ptr->unk20A));
    ptr->slots[0].unk0 = (u32)(a + b) / 3;
    ptr->slots[1].unk0 = (u32)(b + 0x3C + a) / 2;
    ptr->slots[2].unk0 = (u32)(b - 0x48 + a) / 2;
    ptr->slots[3].unk0 = (u32)(a + 0x5A + (b + 0x2D)) / 2;
    ptr->slots[3].val = 2;
}

void ov28_0225E0DC(DowsingMchnAngle *ptr) {
    ptr->unk8 = (ptr->unk0 + ptr->unk4 * 2) / 3;
}
