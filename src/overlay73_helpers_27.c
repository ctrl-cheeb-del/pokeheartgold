...
int ov73_021E93EC(void *p) {
    ov73_021E9F34(p, PTR(p, 0xbd4), 2, 1, 0xf0f);
    ov73_021E83EC(p, 0x2f, 0xd);
    return 3;
}

int ov73_021E941C(void *p) {
    ov72_02237BD0(PTR(p, 0x90), PTR(p, 0x9c), (u8 *)p + 0xa0);
    ov73_021EA15C(p);
    U32(p, 0x1c) = 0x12;
    U32(p, 0xf94) = 0;
    return 3;
