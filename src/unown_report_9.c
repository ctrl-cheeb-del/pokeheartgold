...
void ov113_021E663C(State *p) {
    Heap_Free(*(void **)((u8 *)p + 0x120));
    Heap_Free(*(void **)((u8 *)p + 0x110));
    Heap_Free(*(void **)((u8 *)p + 0x100));
    Heap_Free(*(void **)((u8 *)p + 0x150));
    Heap_Free(*(void **)((u8 *)p + 0x140));
    Heap_Free(*(void **)((u8 *)p + 0x130));
}
