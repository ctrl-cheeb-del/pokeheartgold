...
void ov113_021E6274(void *window, void *string, int font, int x, u16 y) {
    AddTextPrinterParameterizedWithColor(window, font, string, x, y, 0xFF, 0x10200, NULL);
}

void ov113_021E629C(void *window, void *string, int x, u16 y) {
    ov113_021E6274(window, string, 0, x, y);
}
