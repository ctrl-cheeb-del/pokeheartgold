...
void ov59_0223B7D8(u8 *p) {
    ...
    YesNoPrompt_Destroy(*(void **)(p + 0x254));
}

void ov59_0223B804(u8 *p) {
    GF_CreateVramTransferManager(0x20, *(u32 *)p);
    *(void **)(p + 0x258) = SpriteSystem_Alloc(*(u32 *)p);
    SpriteSystem_Init(*(void **)(p + 0x258), ov59_0223CA20, ov59_0223C988, 3);
    thunk_ClearMainOAM(*(u32 *)p);
    thunk_ClearSubOAM(*(u32 *)p);
    *(void **)(p + 0x25c) = SpriteManager_New(*(void **)(p + 0x258));
    SpriteSystem_InitSprites(*(void **)(p + 0x258), *(void **)(p + 0x25c), 0x22);
    sub_0200D2A4(*(void **)(p + 0x258), *(void **)(p + 0x25c), ov59_0223C968, 0, 0);
}

void ov59_0223B878(u8 *p) {
    SpriteSystem_DestroySpriteManager(*(void **)(p + 0x258), *(void **)(p + 0x25c));
    *(void **)(p + 0x25c) = NULL;
    SpriteSystem_Free(*(void **)(p + 0x258));
    *(void **)(p + 0x258) = NULL;
