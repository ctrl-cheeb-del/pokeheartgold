...
void ov59_022395B8(u8 *state) {
    FreeBgTilemapBuffer(*(void **)(state + 0x54), 3);
    FreeBgTilemapBuffer(*(void **)(state + 0x54), 2);
    FreeBgTilemapBuffer(*(void **)(state + 0x54), 1);
    FreeBgTilemapBuffer(*(void **)(state + 0x54), 0);
    FreeBgTilemapBuffer(*(void **)(state + 0x54), 7);
    FreeBgTilemapBuffer(*(void **)(state + 0x54), 4);
    Heap_Free(*(void **)(state + 0x54));
