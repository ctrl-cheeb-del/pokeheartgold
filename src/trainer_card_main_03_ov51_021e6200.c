...
void ov51_021E6200(int palette) {
    void *plttData;
    void *allocation = GfGfxLoader_GetPlttData(0x31, 0x3c, &plttData, 0x19);
    u8 *source = *(u8 **)((u8 *)plttData + 0xc) + palette * 0x20;
    DC_FlushRange(source, 0x20);
    GXS_LoadBGPltt(source, 0x80, 0x20);
