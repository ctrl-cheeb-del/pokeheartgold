...
int ov45_0222F218(void) {
    ...
    return *(u32 *)(_022577C0 + i * 0x4c + 0x5c4) == 1;
}
...
int ov45_0222F274(int i) {
    ...
    return ov45_0223021C(_022577C0, i);
}
...
BOOL ov45_0222F294(int i) {
    ...
    return *(u32 *)(_022577C0 + i * 0x4c + 0x5c4) == 0;
}
...
int ov45_0222F2D4(int i) {
    ...
    p = ov45_022302B0(_022577C0, i);
    return *(u32 *)((u8 *)p + 4) - *(u32 *)((u8 *)p + 8);
}
