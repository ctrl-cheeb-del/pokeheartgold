...
void ov97_0221FC54(State *p) {
    DC_FlushRange(*(void **)((u8 *)p + 0x258), 0xc80);
    GXS_LoadOBJ(*(void **)((u8 *)p + 0x258), *(u32 *)((u8 *)p + 0x27c), 0xc80);
    DC_FlushRange((u8 *)p + 0x25c, 0x20);
    GXS_LoadOBJPltt((u8 *)p + 0x25c, *(u32 *)((u8 *)p + 0x280), 0x20);
}
