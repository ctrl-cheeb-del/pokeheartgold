...
void ov108_021E72A4(SafariAreaCustomizer *s) {
    ListMenuItems_Delete(s->listMenuItems2);
    ListMenuItems_Delete(s->listMenuItems1);
    s->listMenuItems1 = NULL;
    s->listMenuItems2 = NULL;
}

void ov108_021E72CC(SafariAreaCustomizer *s) {
    ov108_021E838C(s);
    s->sub = ov108_021E84A4(s->heapId, 0xC, 1, (void *)2);
    ov108_021E83F0(s);
    s->listMenuSpawner = TouchscreenListMenuSpawner_Create(s->heapId, 0);
    s->fontSystem = FontSystem_NewInit(1, s->heapId);
}

void ov108_021E730C(SafariAreaCustomizer *s) {
    sub_020135AC(s->fontSystem);
    TouchscreenListMenuSpawner_Destroy(s->listMenuSpawner);
    ov108_021E844C(s);
    ov108_021E84DC(s->sub);
    ov108_021E83C8(s);
}
