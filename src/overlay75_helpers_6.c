...
void ov75_02247838(State *p) {
    RemoveWindow((u8 *)p + 0x48);
    RemoveWindow((u8 *)p + 0x58);
    RemoveWindow((u8 *)p + 0x68);
}

void ov75_02247854(State *p, u32 a, u32 b) {
    *(u32 *)((u8 *)p + 8) = a;
    *(u32 *)((u8 *)p + 0xc) = b;
}

void ov75_0224785C(State *p) {
    if (!*(void **)((u8 *)p + 0x8c)) {
        *(void **)((u8 *)p + 0x8c) = WaitingIcon_New((u8 *)p + 0x48, 1);
    }
}

void ov75_02247878(State *p) {
    if (*(void **)((u8 *)p + 0x8c)) {
        sub_0200F450(*(void **)((u8 *)p + 0x8c));
        *(void **)((u8 *)p + 0x8c) = 0;
    }
}
