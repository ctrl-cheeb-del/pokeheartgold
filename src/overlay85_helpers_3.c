...
BOOL ov85_021E5C58(BattleArcadeWork *work) {
    u16 v = 8;
    if (sub_02096D4C((void *)work->unk_0D0, 8, &v, 2) == 1) {
        work->unk_000 = 10;
    }
    return FALSE;
}
...
BOOL ov85_021E5C80(BattleArcadeWork *work) {
    if (sub_02096D4C((void *)work->unk_0D0, 9, NULL, 0) == 1) {
        work->unk_010 = 0;
        work->unk_000 = 9;
        return FALSE;
    }
...
BOOL ov85_021E5CA4(BattleArcadeWork *work) {
    if (ov85_021E8614(work, 8) == 1) {
        if ((s32)work->unk_030 < 2) {
            GF_AssertFail();
        }
        if (work->unk_02C == 0) {
            GF_AssertFail();
...
BOOL ov85_021E5CFC(BattleArcadeWork *work) {
    if (sub_02096D4C((void *)work->unk_0D0, 14, (void *)(work->unk_0CC + 4), 4)) {
        work->unk_000 = 13;
    }
    return FALSE;
}
...
BOOL ov85_021E5D20(BattleArcadeWork *work) {
    if (sub_02036FD8(0x83, (void *)work->unk_024, 0x590)) {
        work->unk_000 = 14;
    }
    return FALSE;
}
