...
int ov73_021E99D4(void *p) {
    BufferIntegerAsString(PTR(p, 0xbd0), 0, U32(p, 0x9c), 3, 2, 1);
    BufferIntegerAsString(PTR(p, 0xbd0), 1, U32(p, 0x94), 2, 2, 1);
    ov73_021E9F34(p, PTR(p, 0xbd4), 1, 1, 0xf0f);
    ov73_021E83EC(p, 0x2f, 0x24);
    U32(p, 0x1c) = 0x24;
    return 3;
}

int ov73_021E9A3C(void *p) {
    ov72_02237BD0(PTR(p, 0x94), PTR(p, 0x9c), (u8 *)p + 0xa0);
    U32(p, 0x1c) = 0x25;
    U32(p, 0xf94) = 0;
    ov73_021EA15C(p);
    return 3;
