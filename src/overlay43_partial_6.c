...
void ov43_0222A87C(u8 *p, int heap) {
    *(void **)(p + 0x50) = MessageFormat_New(heap);
    *(void **)(p + 0x54) = NewMsgDataFromNarc(0, 0x1B, 0x30B, heap);
    FontID_Alloc(4, heap);
}

void ov43_0222A8A8(u8 *p) {
    FontID_Release(4);
    DestroyMsgData(*(void **)(p + 0x54));
    MessageFormat_Delete(*(void **)(p + 0x50));
}
