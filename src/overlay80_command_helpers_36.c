...
void ov80_0222EC60(void *m, int v) {
    if (v == -3) {
        ListMenuOverrideSetColors(m, 3, 15, 4);
    } else {
        ListMenuOverrideSetColors(m, 1, 15, 2);
    }
}

u32 ov80_0222EC84(void *p) {
    return ListMenuGetTemplateField(p, 0x13);
}
