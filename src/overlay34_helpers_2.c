...
void ov34_0225D5F8(Ov34State *p) {
    *(u32 *)((u8 *)p + 0x294) = 0;
    *(u16 *)((u8 *)p + 0x284) = 0;
    *(u16 *)((u8 *)p + 0x286) = 0;
    *(u16 *)((u8 *)p + 0x288) = 0;
    *(u16 *)((u8 *)p + 0x28A) = 0;
    *(void **)((u8 *)p + 0x18) = MessageFormat_New(4);
    *(void **)((u8 *)p + 0x1C) = NewMsgDataFromNarc(0, 0x1B, 0x2E2, 4);
    *(void **)((u8 *)p + 0x20) = GfGfxLoader_GetScrnData(0x49, 3, 1, (void **)((u8 *)p + 0x24), 4);
}
