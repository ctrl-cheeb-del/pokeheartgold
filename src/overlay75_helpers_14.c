...
int ov75_0224921C(Task *t) {
    if (t->next != 0x1e) {
        sub_0203957C();
    }
    sub_0203A914();
    ov75_02247878((State *)t);
    BeginNormalPaletteFade(0, 0, 0, 0, 6, 1, 0x74);
    t->next = 0;
    return 1;
}

int ov75_02249258(Task *t) {
    *(void **)((u8 *)t + 0x88) = ov75_02247890(*(void **)((u8 *)t + 4), 0x234, 0);
    t->next = t->x;
    return 0;
}
