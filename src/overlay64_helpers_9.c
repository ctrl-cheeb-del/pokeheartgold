...
void ov64_021E6BD8(State *p, int x) {
    u8 *b = GridInputHandler_GetDpadBox(*(void **)((u8 *)p + 0x180));
    ManagedSprite_SetPositionXY(*(void **)((u8 *)p + 0x170), b[0], b[1]);
    if (x == 6) {
        x = 4;
    } else {
        x = 3;
    }
    ManagedSprite_SetAnimationFrame(*(void **)((u8 *)p + 0x170), 0);
    ManagedSprite_SetAnim(*(void **)((u8 *)p + 0x170), x);
}
