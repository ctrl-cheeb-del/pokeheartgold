...
void ov93_0225ED3C(void *p) {
    GX_BeginLoadTexPltt();
    GX_LoadTexPltt(PAT(p, 0x250), U32AT(p, 0x258), U32AT(p, 0x254));
    GX_EndLoadTexPltt();
}
...
void ov93_0225ED60(void *p, s32 n) {
    ...
    BlendPalette(PAT(p, 0x24c), PAT(p, 0x250), (u16)(U32AT(p, 0x254) >> 1), (u8)t, 0x1f);
    DC_FlushRange(PAT(p, 0x250), U32AT(p, 0x254));
    U8AT(p, 0x276) = 1;
}
...
u32 ov93_0225EDB8(void *p, s32 d) {
    ...
    ret = 0;
    S32AT(p, 0x25c) += d;
    if (S32AT(p, 0x25c) >= 0x320) {
        S32AT(p, 0x25c) = 0x320;
        ret = 1;
    }
    ov93_0225ED60(p, S32AT(p, 0x25c));
    return ret;
}
...
void ov93_0225EDFC(void *p) {
    if (S16AT(p, 0x268) != 0) {
        ...
        ++;
        if (U8AT(p, 0x275) == 4) {
            ov93_0225ED60(p, S32AT(p, 0x25c) / 2);
            return;
        }
        if (U8AT(p, 0x275) == 8) {
            ov93_0225ED60(p, S32AT(p, 0x25c));
...
void ov93_0225EE4C(u32 a, u32 b) {
    u32 v0;
    u32 v1;
    v0 = 0x21085ef7 | ((a != 0 ? 1 : 0) << 0xf);
    NNS_G3dGeBufferOP_N(0x30, &v0, 1);
    v1 = 0x7fff | ((b != 0 ? 1 : 0) << 0xf);
    NNS_G3dGeBufferOP_N(0x31, &v1, 1);
}
