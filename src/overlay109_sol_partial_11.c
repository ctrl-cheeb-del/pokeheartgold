...
void ov109_021E6E64(PhotoAlbumApp *app) {
    SpriteSystem_DestroySpriteManager(app->spriteSystem, app->spriteManager);
...
void ov109_021E6E9C(PhotoAlbumApp *app) {
    ov109_021E6DE4(app);
    ov109_021E6EE4(app);
    app->listMenu = TouchscreenListMenuSpawner_Create(app->heapId, NULL);
...
void ov109_021E6EC0(PhotoAlbumApp *app) {
    ...
    ov109_021E6F60(app);
    TouchscreenListMenuSpawner_Destroy(app->listMenu);
    ov109_021E6E64(app);
}
