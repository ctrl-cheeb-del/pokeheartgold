...
u32 ov96_021E6A54(Work*w){U32(w,0xd2c)=1;PokeathlonCourse_ResetDataCopyArea(w);U32(w,0x1e0)=(u32)ov96_0221A808;U8(w,0x1ed)=0;PokeathlonCourse_InitStateInfo(ov96_0221DA50,w->d+0x3cc);PokeathlonCourse_SetStateField07(w,8);return 0;}

u32 ov96_021E6A94(Work*w){if(PokeathlonCourse_RunSubStateLoop(w)){u8*d=PokeathlonCourse_GetDataCopyArea(w);d[0x24]=0;d[0x4c]=1;ov96_021E87B0(PokeathlonCourse_GetSystem(w),1);PokeathlonCourse_SetStateTransitionType(w,6);PokeathlonCourse_SetStateField07(w,9);Sound_SetScene(0);Sound_SetSceneAndPlayBGM(0x19,0x46f,0);}return 0;}
