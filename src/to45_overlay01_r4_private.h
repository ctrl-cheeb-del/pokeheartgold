...
#define ov01_02204698 ov01_02204698_header_return_mismatch
...
typedef struct MapLoadSlot {
    void *unk00;           // 0x00
    MapLoadedChunk *unk04; // 0x04
    MapLoadedChunk *unk08; // 0x08
    SysTask *unk0C;        // 0x0C
    void *unk10;           // 0x10
    int unk14;             // 0x14
    int unk18;             // 0x18
...
struct MapLoadManager {
    ...
    u8 unk60;                    // 0x60
    u8 pad_61[0x64 - 0x61];      // 0x61
    MapLoadPending unk64;        // 0x64
    u8 unk7C;                    // 0x7C
    u8 unk7D;                    // 0x7D
    u8 pad_7E[0x80 - 0x7E];      // 0x7E
    u32 unk80[4];                // 0x80
    ...
    int unkF4;                   // 0xF4
    FieldSystemUnkSubCC *unkF8;  // 0xF8
...
BOOL ov01_021F5BBC(u8 direction, MapLoadManager *mapLoadManager, u8 *slot);
void ov01_021FB2F4(Ov01FB04C_Buffers *bufs);
int ov01_02204698(FieldSystemUnkSubCC *manager);
