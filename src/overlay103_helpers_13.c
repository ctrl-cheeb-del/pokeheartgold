...
u32 ov103_021ED9D8(void *a0) {
    ...
    ov103_021EE0CC(PAT(a0, W_SUB), 2, 1);
    ov103_021EDB60(PAT(a0, W_SUB), 0);
    return 9;
}

u32 ov103_021EDA14(void *a0, u32 a1) {
    BeginNormalPaletteFade(0, 1, 1, 0, 6, 1, 0x9d);
    U32AT(PAT(a0, W_SUB), S_NEXT) = a1;
    return 2;
}

u32 ov103_021EDA40(void *a0, u32 a1) {
    BeginNormalPaletteFade(0, 0, 0, 0, 6, 1, 0x9d);
    U32AT(PAT(a0, W_SUB), S_NEXT) = a1;
    return 2;
}

u32 ov103_021EDA70(void *a0, u32 a1, u32 a2) {
    U8AT(PAT(a0, W_SUB), S_FLAG235) = a1;
    U32AT(a0, W_STATE) = a2;
    return 3;
}

u32 ov103_021EDA84(void *a0, u32 a1) {
    U32AT(PAT(a0, W_SUB), S_YNBRANCH) = a1;
    ov103_021ECEA4(a0);
    return 4;
}
