...
u32 ov103_021ED8D0(void *a0) {
    if (ov103_021EEB04() == 1) {
        PlaySE(0x5DD);
        return ov103_021EDB18(a0, 3, 0x10);
    }
    return 0xf;
}
...
u32 ov103_021ED8F8(void *a0) {
    ov103_021EDBC8(a0);
    ov103_021EEAC8(a0, GridInputHandler_GetNextInput(PAT(PAT(a0, W_SUB), S_GRID)));
    ov103_021EE628(PAT(a0, W_SUB));
    sub_0201980C(PAT(PAT(a0, W_SUB), S_WINSET), 0xa);
    ov103_021EDB60(PAT(a0, W_SUB), 0);
    return 9;
}

u32 ov103_021ED930(void *a0) {
    return ov103_021EDA84(a0, 0);
}

u32 ov103_021ED93C(void *a0) {
    ov103_021EE8A8(a0, 2);
    return ov103_021EDA70(a0, 0, 0x13);
}

u32 ov103_021ED954(void *a0) {
    return ov103_021EDA84(a0, 1);
}

u32 ov103_021ED960(void *a0) {
    if (U8AT(a0, W_RET20) != 6) {
        U32AT(a0, W_STATE) = 0x15;
        return 0;
    }
    U32AT(a0, W_BRANCH) = 2;
    return 6;
...
u32 ov103_021ED97C(void *a0) {
    ov103_021EE0CC(PAT(a0, W_SUB), 2, 0);
    ov103_021EDB60(PAT(a0, W_SUB), 1);
    return ov103_021EDA14(a0, 0x16);
}

u32 ov103_021ED99C(void *a0) {
    ov103_021EE860(a0);
    return ov103_021EDE7C(a0);
}
