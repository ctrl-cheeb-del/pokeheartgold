...
u32 ov49_02259130(void *p) {
    return ov45_0223089C((void *)U32_AT(p, 4));
}

u32 ov49_0225913C(void *p) {
    return ov45_022308C0((void *)U32_AT(p, 4));
}

u32 ov49_02259148(void *p) {
    return ov45_022308E4((void *)U32_AT(p, 4));
}

u32 ov49_02259154(void *p) {
    return ov45_02230908((void *)U32_AT(p, 4));
}

u32 ov49_02259160(void *p) {
    return ov45_02230920((void *)U32_AT(p, 4));
}

void ov49_0225916C(void *p, u32 enabled) {
    if (enabled != 0) {
        ov45_0223093C((void *)U32_AT(p, 4), 1);
    } else {
        ov45_02230968((void *)U32_AT(p, 4), enabled);
    }
}

void ov49_02259184(void *p, u32 enabled) {
    if (enabled != 0) {
        ov45_0223093C((void *)U32_AT(p, 4), 0);
    } else {
        ov45_02230968((void *)U32_AT(p, 4), enabled);
    }
}
...
void ov49_0225919C(void *p, u32 enabled) {
    if (enabled != 0) {
        ov45_0223093C((void *)U32_AT(p, 4), 2);
    } else {
        ov45_02230968((void *)U32_AT(p, 4), enabled);
    }
}
...
u32 ov49_022591B4(void *p) {
    return ov45_022308B0((void *)U32_AT(p, 4));
}

u32 ov49_022591C0(void *p) {
    return ov45_02230978((void *)U32_AT(p, 4));
}

u32 ov49_022591CC(void *p) {
    return ov45_02230994((void *)U32_AT(p, 4));
}
