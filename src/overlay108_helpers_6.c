...
void ov108_021E6804(SafariAreaCustomizer *s) {
    s->mode = 2;
    ov108_021E78F4(s, 0, s->unk184E0);
    thunk_Sprite_SetPriority(s->sprites[0], 0);
    ov108_021E78F4(s, 3, s->unk184DF);
    ov108_021E7700(s, 0, 2, 1);
}

void ov108_021E6850(SafariAreaCustomizer *s) {
    s->mode = 0;
    ov108_021E78F4(s, 0, s->unk184DF);
    thunk_Sprite_SetPriority(s->sprites[0], 2);
    ov108_021E78C0(s, 3, 0, 0);
    ov108_021E7700(s, 0, 0, 1);
}
