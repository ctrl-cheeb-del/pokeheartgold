...
void ov103_021ECD18(void *a0) {
    void *sub = PAT(a0, W_SUB);
    u32 frame = (u8)Options_GetFrame(PAT(a0, W_OPTIONS));
    LoadUserFrameGfx2(PAT(sub, S_BGCFG), 0, 0x3E2, 0xd, frame, 0x9d);
    LoadFontPal1(0, 7 << 6, 0x9d);
    LoadFontPal0(0, 0x1e << 4, 0x9d);
    LoadFontPal0(4, 0x1e << 4, 0x9d);
}
