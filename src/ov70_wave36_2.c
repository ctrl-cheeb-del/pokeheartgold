...
void ov70_02239C34(void *win,void *msg,u32 font,u32 id,u32 unused){void *s=NewString_ReadMsgData(msg,id);AddTextPrinterParameterizedWithColor(win,font,s,0,0,0,0x000a0900,NULL);String_Delete(s);}
