...
void ov28_0225DB54(DowsingMchn *ptr) {
    Sprite_Delete(ptr->sprites[0]);
    Sprite_Delete(ptr->sprites[1]);
    Sprite_Delete(ptr->sprites[2]);
    SpriteTransfer_DeleteCharTransferTask((SpriteResource *)ptr->resObjA[0]);
    SpriteTransfer_DeletePlttTransferTask((SpriteResource *)ptr->resObjA[1]);
}
