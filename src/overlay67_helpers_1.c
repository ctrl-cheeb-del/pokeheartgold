...
int ov67_021E5900(OverlayManager *mgr, int *state) {
    u8 *args = OverlayManager_GetArgs(mgr);
    State *p;
    Heap_Create(3, 0x48, 0x20000);
    p = OverlayManager_CreateAndGetData(mgr, 0x4AC, 0x48);
    memset(p, 0, 0x4AC);
    *(u16 *)((u8 *)p + 8) = *(u16 *)(args + 4);
    *((u8 *)p + 0xA) = *(u16 *)(args + 6);
    *(void **)((u8 *)p + 0x18) = Save_PlayerData_GetOptionsAddr(*(void **)args);
    *(void **)((u8 *)p + 0x1C) = Save_Frontier_GetStatic(*(void **)args);
    *(void **)((u8 *)p + 0x20) = Save_FrontierData_Get(*(void **)args);
    *(void **)((u8 *)p + 0x24) = sub_0202D928(*(void **)args);
    *(u32 *)p = 0x48;
    SetKeyRepeatTimers(4, 8);
    return 1;
}

int ov67_021E5968(OverlayManager *mgr, int *state) {
