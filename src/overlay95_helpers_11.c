...
void ov95_021E7078(State *p) {
    ...
    ov95_021E7404(p);
    FontID_Release(4);
    MessageFormat_Delete(*(void **)((u8 *)p + 0x14));
    FreeBgTilemapBuffer(*(void **)((u8 *)p + 0xc), 4);
    FreeBgTilemapBuffer(*(void **)((u8 *)p + 0xc), 5);
    FreeBgTilemapBuffer(*(void **)((u8 *)p + 0xc), 6);
    Heap_Free(p);
}
