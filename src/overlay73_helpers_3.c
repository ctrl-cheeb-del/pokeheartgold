...
void ov73_021E6400(void *p) {
    YesNoPrompt_Destroy(PTR(p, 0x2e8));
    RemoveWindow((u8 *)p + 0x298);
    RemoveWindow((u8 *)p + 0x2d8);
    RemoveWindow((u8 *)p + 0x2a8);
    RemoveWindow((u8 *)p + 0x2b8);
    RemoveWindow((u8 *)p + 0x2c8);
}
