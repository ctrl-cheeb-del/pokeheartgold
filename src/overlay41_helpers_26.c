...
void ov41_02247D00(Ov41Work *w) {
    ClearWindowTilemapAndCopyToVram((void *)W(w, 0x6bc));
    RemoveWindow((void *)W(w, 0x6bc));
}

void ov41_02247D1C(void *a, void *b) {
    ov41_02247BB8(a, b, 2, 1, 0x1b, 2);
}
...
void ov41_02247D44(Ov41Work *w) {
    u32 n = ov41_022482B4((Ov41Work *)AT(w, 0x3f4));
    ov41_0224AC98(AT(w, 0x568), n);
}
