...
void ov18_021F6E58(void *p, int a1) {
    u8 x;
    u8 y;
    DpadMenuBox_GetPosition(GridInputHandler_GetDpadBox(*(void **)((u8 *)p + 0x1864), a1), &x, &y);
    ManagedSprite_SetPositionXY(*(ManagedSprite **)((u8 *)p + 0x670), x, y);
    ov18_021F118C(p, 0, ov18_021FBD1C[a1]);
}
