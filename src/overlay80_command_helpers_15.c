...
int FrtCmd_050(void *c) {
    ...
    ov80_02239708(sub_0209680C(APP(c)), v, 0);
    return 0;
}

int FrtCmd_051(void *c) {
    U16(c, 0x78) = FrontierScript_ReadVar(c);
    FrontierScriptContext_Pause(c, ov80_0222CA94);
    return 1;
}
