...
void ov113_021E6930(State *p) {
    SpriteSystem_FreeResourcesAndManager(*(void **)((u8 *)p + 0xAC), *(void **)((u8 *)p + 0xB4));
    SpriteSystem_DestroySpriteManager(*(void **)((u8 *)p + 0xAC), *(void **)((u8 *)p + 0xB0));
    *(void **)((u8 *)p + 0xB4) = NULL;
    *(void **)((u8 *)p + 0xB0) = NULL;
    NARC_Delete(*(void **)((u8 *)p + 0xFC));
    SpriteSystem_Free(*(void **)((u8 *)p + 0xAC));
    *(void **)((u8 *)p + 0xAC) = NULL;
    GF_DestroyVramTransferManager();
    thunk_ClearMainOAM(*(void **)p);
}

void ov113_021E6988(State *p) {
    ov113_021E677C(p);
    ov113_021E69CC(p);
