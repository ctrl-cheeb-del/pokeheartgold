...
BOOL ov82_0223F6CC(Ov82Work *work) {
    if (work->unk009 == 0) {
        if (work->unk01C == 0x32 || work->unk01C == 0xaa) {
            return TRUE;
        }
    }
    return FALSE;
...
BOOL ov82_0223F6E8(Ov82Work *work, u16 cmd, u16 arg) {
    u32 id;
    if (ov80_0223792C(work->unk009) == 0) {
        return FALSE;
    }
    switch (cmd) {
    case 4:
        id = 0x27;
        ov82_0223F74C(work, cmd);
        break;
    case 5:
        id = 0x28;
        ov82_0223F770(work, cmd, arg);
        break;
    case 6:
        id = 0x29;
        ov82_0223F808(work, cmd, arg);
        break;
    }
    if (sub_02037030(id, &work->unk224, 0x2c) == 1) {
        return TRUE;
    }
    return FALSE;
}
...
void ov82_0223F770(Ov82Work *work, u16 a, u16 b) {
    ...
    work->unk224 = a;
    work->unk226 = b;
    if (sub_0203769C() == 0 && work->unk018 == 0xff) {
        work->unk018 = (u8)b;
    }
    work->unk228 = work->unk018;
    mon = Party_GetMonByIndex(work->party, 0);
    work->unk22A = (u16)GetMonData(mon, 0xa1, NULL);
}
...
void ov82_0223F7B4(u32 a, u32 unused, const u16 *msg, Ov82Work *work) {
    ...
    work->unk27C = (u8)msg[1];
    if (sub_0203769C() == 0) {
        if (work->unk018 != 0xff) {
            work->unk27C = 0;
        } else {
            work->unk018 = (u8)(work->unk27C + 0x14);
        }
    } else {
        work->unk018 = (u8)msg[2];
    }
    *(u16 *)work->unk21C = msg[3];
}
