...
BOOL SafariAreaCustomizer_Init(void *man, int *state) {
    void *args = OverlayManager_GetArgs(man);
    SafariAreaCustomizer *s;

#pragma unused(state)
    Heap_Create(3, 0x5F, 5 << 16);
    s = OverlayManager_CreateAndGetData(man, sizeof(SafariAreaCustomizer), 0x5F);
    MI_CpuFill8(s, 0, sizeof(SafariAreaCustomizer));
    s->heapId = 0x5F;
    ov108_021E59E4(s, args);
    Sound_SetSceneAndPlayBGM(0x43, 0, 0);
    return TRUE;
}

BOOL SafariAreaCustomizer_Exit(void *man, int *state) {
    SafariAreaCustomizer *s = OverlayManager_GetData(man);
    u32 heapId;
...
BOOL SafariAreaCustomizer_Main(void *man, int *state) {
    ...
    switch (*state) {
    case 0:
        *state = ov108_021E5A78(s);
        break;
    case 1:
        *state = ov108_021E5A8C(s);
        break;
    case 2:
        *state = ov108_021E5AA0(s);
        break;
    case 3:
        *state = ov108_021E5AF0(s);
        break;
    case 4:
        *state = ov108_021E5B48(s);
        break;
    case 5:
        *state = ov108_021E5B98(s);
        break;
    case 6:
        *state = ov108_021E5BFC(s);
        break;
    case 7:
        return TRUE;
    }
...
void ov108_021E59E4(SafariAreaCustomizer *s, void *args) {
    ...
    s->unk18 = Save_SafariZone_Get(v->unk00);
    SafariZone_CopyAreaSet(s->unk18, 0, s->unk1C);
    opts = Save_PlayerData_GetOptionsAddr(v->unk00);
    s->unk184DC = Options_GetTextSpeed(opts);
    s->unk184DD = Options_GetFrame(opts);
    s->unk10 = MenuInputStateMgr_GetState(v->unk04);
    s->unk184E8 = 0;
    s->unk14 = v;
    if (SafariZone_GetObjectUnlockLevel(s->unk18)) {
        s->unk184E3 = 1;
    }
}

void ov108_021E5A48(SafariAreaCustomizer *s) {
    SafariZone_SetAreaSet(s->unk18, 0, s->unk1C);
    ChangeFlag99D(Save_VarsFlags_Get(s->unk14->unk00), s->unk184E8);
    MenuInputStateMgr_SetState(s->unk14->unk04, s->unk10);
}
...
u32 ov108_021E5AA0(SafariAreaCustomizer *s) {
    switch (s->unk04) {
    case 0:
        s->unk04 = ov108_021E5D90(s);
        break;
    case 1:
        s->unk04 = ov108_021E5DB8(s);
        break;
    case 2:
        s->unk04 = ov108_021E5E68(s);
        break;
    case 3:
        break;
    case 4:
...
u32 ov108_021E5AF0(SafariAreaCustomizer *s) {
    switch (s->unk04) {
    case 0:
        s->unk04 = ov108_021E5F10(s);
        break;
    case 1:
        s->unk04 = ov108_021E5F38(s);
        break;
    case 2:
        s->unk04 = ov108_021E5E68(s);
        break;
    case 3:
        s->unk04 = ov108_021E6010(s);
        break;
    case 4:
        s->unk04 = 0;
        ov108_021E846C(s);
...
u32 ov108_021E5B98(SafariAreaCustomizer *s) {
    switch (s->unk04) {
    case 0:
        BeginNormalPaletteFade(0, 1, 1, 0, 6, 1, s->heapId);
...
u32 ov108_021E5BFC(SafariAreaCustomizer *s) {
    switch (s->unk04) {
    case 0:
        BeginNormalPaletteFade(0, 0, 0, 0, 6, 1, s->heapId);
        s->unk04++;
        break;
    case 1:
        if (IsPaletteFadeFinished()) {
