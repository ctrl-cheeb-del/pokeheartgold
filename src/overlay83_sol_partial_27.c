...
void ov83_02244A74(u8 *p) {
    ov83_02247864(p + 0x604, *(void **)(p + 0x4C));
}

u32 ov83_02244A88(void *p) {
    return ov83_02246C2C(p);
}

u32 ov83_02244A90(void *p) {
    return ov83_02246C70(p);
}

void ov83_02244A98(u8 *p, int field, int value, int digits, int mode) {
    BufferIntegerAsString(*(void **)(p + 0x24), field, value, digits, mode, 1);
}

void ov83_02244AB0(u8 *p, int field, void *mon) {
    BufferBoxMonSpeciesName(*(void **)(p + 0x24), field, mon);
}

void ov83_02244ABC(u8 *p, int field) {
    void *profile = Save_PlayerData_GetProfile(*(void **)(p + 0x2BC));
    BufferPlayersName(*(void **)(p + 0x24), field, profile);
}
