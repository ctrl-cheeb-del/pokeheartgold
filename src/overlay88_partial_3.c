...
void ov88_02258D64(void *out, void *state, int heap) {
    *(void **)out = GfGfxLoader_GetScrnDataFromOpenNarc(
        *(void **)((u8 *)state + 0x140), 5, 0, (void **)((u8 *)out + 4), heap);
}

void ov88_02258D84(void *p) {
    Heap_Free(*(void **)p);
}
