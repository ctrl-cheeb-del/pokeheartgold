...
s32 ov14_021F6A14(void) {
    return TouchscreenHitbox_FindRectAtTouchNew(ov14_021F864C);
}

s32 ov14_021F6A24(void) {
    return TouchscreenHitbox_FindRectAtTouchNew(ov14_021F8614);
}

s32 ov14_021F6A34(void) {
    return TouchscreenHitbox_FindRectAtTouchNew(ov14_021F8630);
}
