...
void ov71_0224A080(Ov71Sub2 *arg) {
    Ov71Bgs *w = (Ov71Bgs *)arg;
    FreeBgTilemapBuffer(w->unk_0C, 3);
    FreeBgTilemapBuffer(w->unk_0C, 7);
    FreeBgTilemapBuffer(w->unk_0C, 2);
    FreeBgTilemapBuffer(w->unk_0C, 6);
    FreeBgTilemapBuffer(w->unk_0C, 1);
    FreeBgTilemapBuffer(w->unk_0C, 5);
}

void ov71_0224A0B8(void *bgConfig, u32 y, u32 x) {
    u32 yy = y & 0x1FF;
    u32 xx = x & 0x1FF;
    BgSetPosTextAndCommit(bgConfig, 2, 3, xx);
    BgSetPosTextAndCommit(bgConfig, 1, 3, yy);
    yy += 0xc0;
    BgSetPosTextAndCommit(bgConfig, 5, 3, yy);
}
