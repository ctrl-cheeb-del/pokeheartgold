...
void ov01_021F55F4(int i0, int i1, int i2, int i3, MapLoadManager *mapLoadManager) {
    ...
    ov01_021F5568(i0, mapLoadManager);
    ov01_021F5568(i1, mapLoadManager);
    t0 = mapLoadManager->maps[i0];
    t1 = mapLoadManager->maps[i1];
    t2 = mapLoadManager->maps[i2];
    mapLoadManager->maps[i0] = t2;
    mapLoadManager->maps[i1] = mapLoadManager->maps[i3];
    mapLoadManager->maps[i2] = t0;
    mapLoadManager->maps[i3] = t1;
}
