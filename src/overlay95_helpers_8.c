...
void ov95_021E62E4(State *p) {
    Pokepic_Delete(*(void **)((u8 *)p + 0x70));
}

void ov95_021E62F0(State *p, int v) {
    Pokepic_SetAttr(*(void **)((u8 *)p + 0x70), 6, v);
}

void ov95_021E6300(State *p) {
    ((void (*)(State *))ov95_021E7810[*(u32 *)((u8 *)p + 0x5c)])(p);
}
