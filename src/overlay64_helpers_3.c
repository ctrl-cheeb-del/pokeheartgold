...
void ov64_021E5CA4(State *p) {
    FreeBgTilemapBuffer(*(void **)((u8 *)p + 4), 5);
    FreeBgTilemapBuffer(*(void **)((u8 *)p + 4), 4);
    FreeBgTilemapBuffer(*(void **)((u8 *)p + 4), 1);
    FreeBgTilemapBuffer(*(void **)((u8 *)p + 4), 0);
    Heap_Free(*(void **)((u8 *)p + 4));
}
