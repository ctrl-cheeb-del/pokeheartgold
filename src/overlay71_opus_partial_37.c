...
Ov71Cell *ov71_0224A920(Ov71Ctx *ctx) {
    Ov71Cell *w = Heap_Alloc(0x39, sizeof(Ov71Cell));
    if (w != NULL) {
        w->unk_00 = ctx;
        w->unk_04 = NULL;
        w->unk_0C = ov71_02247384(ctx);
        w->unk_20 = 0;
        w->unk_10 = 0;
        w->unk_14 = 0;
        w->unk_18 = 0;
...
void ov71_0224A954(Ov71Cell *w) {
    if (w != NULL) {
        ov71_0224ADB0((Ov71Bgs *)w);
        ov71_0224AEF4((Ov71Scene *)w);
        if (w->unk_30 != 0) {
            ov71_0224B068((void *)w->unk_30);
        }
        if (w->unk_34 != 0) {
            ov71_0224AFB8((void *)w->unk_34);
        }
        if (w->unk_38 != 0) {
            ov71_0224B11C((void *)w->unk_38);
        }
        Heap_Free(w);
    }
}
...
BOOL ov71_0224A98C(Ov71Cell *w, u32 *state) {
    if (*state < 3) {
        if (((BOOL (*)(Ov71Cell *, void *))ov71_0224BEF0[*state])(w, &w->unk_04)) {
            *state = *state + 1;
            w->unk_04 = NULL;
        }
        ov71_0224A9C4(w);
