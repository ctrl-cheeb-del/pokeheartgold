...
u32 sub_0205DA34(PlayerAvatar *playerAvatar, LocalMapObject *object, int direction);
u32 sub_0205DFEC(PlayerAvatar *playerAvatar, int direction);
...
void ov01_021FE9F4(u32 a0, int a1);
void ov01_0220609C(FieldSystem *fieldSystem, int a1);
void sub_02069DC8(LocalMapObject *obj, BOOL enable);
BOOL CheckFlag99A(void *varsFlags);
void *Save_VarsFlags_Get(SaveData *saveData);
u16 FieldBGM_GetForMapHeader(FieldSystem *fieldSystem, int mapId);
void FieldBGM_TryFadeOut(FieldSystem *fieldSystem, u16 seqNo, int mode);
u16 SndRadio_GetSeqNo(void);
void FieldSystem_ProcessSoundplate(FieldSystem *fieldSystem, int a1);
...
void FieldSystem_UnkSub108_AddMonMood(void *unk108, int amount);
