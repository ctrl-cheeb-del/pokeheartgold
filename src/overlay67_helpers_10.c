...
void ov67_021E6BB8(State *p) {
    ov67_021E6B6C(p, 1);
}

void ov67_021E6BC4(State *p) {
    *(void **)((u8 *)p + 0x4A4) = GridInputHandler_Create(ov67_021E6E60, ov67_021E6EE8, ov67_021E6D6C, p, 1, 0, *(u32 *)p);
    ov67_021E6C14(p, 0);
}

void ov67_021E6C04(State *p) {
    GridInputHandler_Free(*(void **)((u8 *)p + 0x4A4));
}

void ov67_021E6C14(State *p, int input) {
    u8 pos[2];
    void *box = GridInputHandler_GetDpadBox(*(void **)((u8 *)p + 0x4A4));
    DpadMenuBox_GetPosition(box, &pos[1], &pos[0]);
    ov67_021E6A28(p, 0, pos[1], pos[0]);
    if (input == 12) {
        ov67_021E6A08(p, 0, 2);
    } else {
        ov67_021E6A08(p, 0, 7);
