...
int ov95_021E6150(State *p, int a) {
    if (ov95_021E60A4(p) == 0) {
        return 2;
    }
    if (a == 4) {
        if (*(u32 *)((u8 *)p + 0x84) == 6) {
    ...
    } else if (*(u32 *)((u8 *)p + 0x84) == 6) {
        return 1;
    }
    return 0;
}

void ov95_021E6184(State *p) {
    Sprite_DeleteAndFreeResources(*(void **)((u8 *)p + 0x74));
    Sprite_DeleteAndFreeResources(*(void **)((u8 *)p + 0x78));
    Sprite_DeleteAndFreeResources(*(void **)((u8 *)p + 0x7c));
}
