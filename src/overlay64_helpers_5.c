...
void ov64_021E6118(State *p) {
    String_Delete(*(void **)((u8 *)p + 0x1a8));
    String_Delete(*(void **)((u8 *)p + 0x1a4));
    String_Delete(*(void **)((u8 *)p + 0x12c));
    String_Delete(*(void **)((u8 *)p + 0x128));
    MessageFormat_Delete(*(void **)((u8 *)p + 0x124));
    DestroyMsgData(*(void **)((u8 *)p + 0x120));
    DestroyMsgData(*(void **)((u8 *)p + 0x11c));
    DestroyMsgData(*(void **)((u8 *)p + 0x118));
}
