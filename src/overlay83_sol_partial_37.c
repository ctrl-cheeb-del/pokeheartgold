...
void ov83_02245CA8(u8 *p, u8 index) {
    if ((*(u8 **)(p + 0x554))[index] == 1) {
        ov83_0224755C(*(Ov83SpriteWrap **)(p + 0x520 + index * 8), 1);
    }
    if ((*(u8 **)(p + 0x558))[index] == 1) {
        ov83_0224755C(*(Ov83SpriteWrap **)(p + 0x524 + index * 8), 1);
    }
}

void ov83_02245CE8(u8 *p, u32 *a, u32 *b) {
    *a = ov80_02237D8C(p[9]) == 1 ? 0x40 : 0x60;
    *b = 0x3C;
}
