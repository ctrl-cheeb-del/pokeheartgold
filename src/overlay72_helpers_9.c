...
void ov72_02239098(u8 *p) {
    String_Delete(*(void **)(p + 0xbf0));
    String_Delete(*(void **)(p + 0xbe4));
    String_Delete(*(void **)(p + 0xbec));
    String_Delete(*(void **)(p + 0xbe8));
    String_Delete(*(void **)(p + 0xbe0));
}

int ov72_022390D8(u8 *p) {
    ov72_0223A350(p, *(void **)(p + 0xbdc), 0x11, 1, 0xf0f);
    ov72_02238680(p, 0x30, 1);
    return 3;
}
