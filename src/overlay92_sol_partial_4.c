...
void ov92_0225D970(void *p, void *a, void *b) {
    if (U32AT(p, 0x6c) != 0) {
        NNS_G3dGlbFlushP();
        NNS_G3dGeBufferOP_N(0x1c, b, 3);
        NNS_G3dGeBufferOP_N(0x19, a, 0xc);
        NNS_G3dGlbSetBaseScale((VecFx32 *)((u8 *)p + 0x60));
        NNS_G3dDraw((NNSG3dRenderObj *)p);
    }
}

void ov92_0225D9A8(void *p, int a, int b) {
    sub_02018030((u8 *)p + 0x78, a, b, 0x71);
}
