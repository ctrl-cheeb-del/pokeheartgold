...
void ov45_0222A404(u8 *p) {
    ov45_0222BCA0((s16 *)(p + 0x3a0));
}

int ov45_0222A414(u8 *p) {
    return ov45_0222BCA8((s16 *)(p + 0x3a0));
}

void *ov45_0222A424(Overlay45State *p) {
    return *(void **)&p->data[0x50c];
}

void ov45_0222A430(Overlay45State *p, void *v) {
    *(void **)&p->data[0x50c] = v;
}
