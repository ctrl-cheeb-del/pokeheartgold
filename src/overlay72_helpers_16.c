...
int ov72_02239B5C(u8 *p) {
    ov72_0223A350(p, *(void **)(p + 0xbd4), 8, 1, 0xf0f);
    ov72_02238680(p, 0x2f, 0x2d);
    ov72_0223A444(p);
    *(u32 *)(*(u8 **)p + 0x20) = 0;
    return 3;
}

int ov72_02239B98(u8 *p) {
    ov72_0223A350(p, *(void **)(p + 0xbd4), 5, 1, 0xf0f);
    ov72_02238680(p, 0x2f, 0x1e);
    return 3;
}

int ov72_02239BC8(u8 *p) {
    *(u32 *)(p + 0x94) = 1;
    ov72_0223A41C(p, 1, 1);
    ov72_0223A520(p, 1, 0xa);
    *(u32 *)(p + 0x1c) = 0x1f;
    return 3;
}
