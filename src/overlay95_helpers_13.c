...
void ov95_021E72B8(State *p) {
    AddWindowParameterized(*(void **)((u8 *)p + 0xc), (u8 *)p + 0x1c, 6, 4, 8, 0x18, 2, 0xf, 0x50);
    AddWindowParameterized(*(void **)((u8 *)p + 0xc), (u8 *)p + 0x2c, 6, 4, 0xe, 0x18, 2, 0xf, 0x80);
}
