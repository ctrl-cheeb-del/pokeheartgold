...
void *ov73_021E6BF8(void *p, void *ret) {
    ov73_021EA3D0(PTR(p, 0x4a0c), (u8 *)p + 0xf48);
    U32(p, 0x318) = 0x1b;
    return ret;
}

void *ov73_021E6C20(void *p, void *ret) {
    U8(gSystem, 0x6c) = 1;
    GameStats_AddScore(PTR(PTR(p, 8), 0xc), 0x13);
    sub_02039EAC((u8 *)p + 0x374);
    U32(p, 0x318) = 0x1c;
    return ret;
}
