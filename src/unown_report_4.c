...
void ov113_021E5CF8(State *p) {
    ov113_021E6300(p);
    ov113_021E650C(p);
    ov113_021E6680(p);
    ov113_021E671C(p);
    ov113_021E6988(p);
    Main_SetVBlankIntrCB((void (*)(void *))ov113_021E62B0, p);
}

void ov113_021E5D28(State *p) {
    ov113_021E69A8(p);
    ov113_021E6754(p);
    ov113_021E66E4(p);
    ov113_021E663C(p);
...
void ov113_021E5D4C(State *p) {
    ov113_021E5E64(p, 0);
    ov113_021E5DA4(p, *((u8 *)p + 0x1A));
}
