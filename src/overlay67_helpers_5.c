...
void ov67_021E6080(State *p) {
    ...
    if (n > 0) {
        p = (State *)((u8 *)p + 0x6C);
        do {
            ClearWindowTilemapAndCopyToVram(p);
            RemoveWindow(p);
            i++;
            p = (State *)((u8 *)p + 0x10);
        } while (i < n);
...
void ov67_021E60B4(State *p) {
    *(void **)((u8 *)p + 0x28) = NewMsgDataFromNarc(0, 0x1B, 0x1C, *(u32 *)p);
    *(void **)((u8 *)p + 0x2C) = MessageFormat_New_Custom(2, 0x40, *(u32 *)p);
    *(void **)((u8 *)p + 0x30) = String_New(0x200, *(u32 *)p);
    *(void **)((u8 *)p + 0x64) = NewString_ReadMsgData(*(void **)((u8 *)p + 0x28), 0x21);
    *(void **)((u8 *)p + 0x68) = NewString_ReadMsgData(*(void **)((u8 *)p + 0x28), 0x22);
}

void ov67_021E60F4(State *p) {
    String_Delete(*(void **)((u8 *)p + 0x68));
    String_Delete(*(void **)((u8 *)p + 0x64));
    String_Delete(*(void **)((u8 *)p + 0x30));
    MessageFormat_Delete(*(void **)((u8 *)p + 0x2C));
    DestroyMsgData(*(void **)((u8 *)p + 0x28));
}
