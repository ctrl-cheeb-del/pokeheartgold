...
void ov43_0222A500(void **p) {
    SpriteList_RenderAndAnimateSprites(p[1]);
}

void ov43_0222A50C(void **p) {
    DoScheduledBgGpuUpdates(p[0]);
    GF_RunVramTransferTasks();
    OamManager_ApplyAndResetBuffers();
}

void ov43_0222A520(u8 *p) {
    ov43_0222ACDC(p);
    ov43_0222A9D8(p);
    ov43_0222A960(p);
    ov43_0222A8A8(p);
    ov43_0222A81C(p);
    ov43_0222A66C((void **)p);
    NARC_Delete(*(void **)(p + 0x58));
}
