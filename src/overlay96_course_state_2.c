...
u32 ov96_021E695C(Work*w){U32(w,0x200)=0;if(ov96_021E87EC(0x17,w->d+0x200,ov96_021E99F8(),(void*)U32(w,0x288)))PokeathlonCourse_SetStateField07(w,0x26);return 0;}

u32 ov96_021E6990(Work*w){void*a=PokeathlonCourse_GetParticipantData(w,0);void*b=ov96_021E99FC();void*c=PokeathlonCourse_GetSystem(w);if(ov96_021E87EC(0x18,a,b,c))PokeathlonCourse_SetStateField07(w,0x26);return 0;}

u32 ov96_021E69C4(Work*w){BOOL ok=1;if(!ov96_021E5F24(w))ok=ov96_021E87EC(0x19,(void*)U32(w,0x5dc),ov96_021E9A04(),(void*)U32(w,0x288));if(ok)PokeathlonCourse_SetStateField07_IfDifferent(w,0x26,6);return 0;}
