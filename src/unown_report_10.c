...
void ov113_021E66E4(State *p) {
    String_Delete(*(void **)((u8 *)p + 0x5C));
    String_Delete(*(void **)((u8 *)p + 0x58));
    String_Delete(*(void **)((u8 *)p + 0x54));
    String_Delete(*(void **)((u8 *)p + 0x50));
    String_Delete(*(void **)((u8 *)p + 0x4C));
    MessageFormat_Delete(*(void **)((u8 *)p + 0x48));
    DestroyMsgData(*(void **)((u8 *)p + 0x44));
    FontID_Release(4);
}
