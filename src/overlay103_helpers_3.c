...
void ov103_021ECBBC(void *a0) {
    FreeBgTilemapBuffer(PAT(PAT(a0, W_SUB), S_BGCFG), 3);
    FreeBgTilemapBuffer(PAT(PAT(a0, W_SUB), S_BGCFG), 2);
    FreeBgTilemapBuffer(PAT(PAT(a0, W_SUB), S_BGCFG), 1);
    FreeBgTilemapBuffer(PAT(PAT(a0, W_SUB), S_BGCFG), 0);
    FreeBgTilemapBuffer(PAT(PAT(a0, W_SUB), S_BGCFG), 7);
    FreeBgTilemapBuffer(PAT(PAT(a0, W_SUB), S_BGCFG), 6);
    FreeBgTilemapBuffer(PAT(PAT(a0, W_SUB), S_BGCFG), 5);
    FreeBgTilemapBuffer(PAT(PAT(a0, W_SUB), S_BGCFG), 4);
    Heap_Free(PAT(PAT(a0, W_SUB), S_BGCFG));
}
