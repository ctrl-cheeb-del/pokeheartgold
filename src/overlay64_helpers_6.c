...
void ov64_021E622C(State *p) {
    *(void **)((u8 *)p + 0x180) = GridInputHandler_Create(ov64_021E6F6C, ov64_021E7008, ov64_021E6EA8, p, 1, 0, 0x3b);
}

void ov64_021E6260(State *p) {
    GridInputHandler_Free(*(void **)((u8 *)p + 0x180));
}
...
void ov64_021E6278(State *p, int x) {
    ov64_021E6BD8(p, x);
}

void ov64_021E6280(State *p, int x) {
    ov64_021E6BD8(p, x);
}

void ov64_021E6288(void) {
    BeginNormalPaletteFade(0, 1, 1, 0, 6, 1, 0x3b);
}

void ov64_021E62A8(void) {
    BeginNormalPaletteFade(0, 0, 0, 0, 6, 1, 0x3b);
}
