...
void ov67_021E5E84(State *p) {
    FreeBgTilemapBuffer(*(void **)((u8 *)p + 0x10), 5);
    FreeBgTilemapBuffer(*(void **)((u8 *)p + 0x10), 4);
    FreeBgTilemapBuffer(*(void **)((u8 *)p + 0x10), 1);
    FreeBgTilemapBuffer(*(void **)((u8 *)p + 0x10), 0);
    Heap_Free(*(void **)((u8 *)p + 0x10));
}
