...
BOOL ov41_02249768(Ov41Work *w) {
    return TouchscreenHitbox_TouchHeldIsIn((TouchscreenHitbox *)AT(w, 4));
}

BOOL ov41_02249774(Ov41Work *w, u32 x, u32 y) {
    return TouchscreenHitbox_PointIsIn((TouchscreenHitbox *)AT(w, 4), x, y);
}

void ov41_02249780(Ov41Work *w, u32 *a, u32 *b) {
    *a = Pokepic_GetAttr((void *)W(w, 0), 0);
    *b = Pokepic_GetAttr((void *)W(w, 0), 1);
}
