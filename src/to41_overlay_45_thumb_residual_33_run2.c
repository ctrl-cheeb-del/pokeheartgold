...
void ov45_0222E91C(void) {
    ...
    ov45_0222F78C();
    if (ov45_0222F74C(ov45_02231490()) == 0) {
        GF_AssertFail();
    }
}
...
void *ov45_0222E9E0(void) {
    ...
    return ov45_02232580();
}

void ov45_0222E9F8(void *x) {
    void *v;
    if (_022577C0 == NULL) {
        GF_AssertFail();
    }
    v = ov45_02232580();
    ov45_0222F88C(_022577C0, v, (int)x);
    ov45_022325B0(x, *(void **)(_022577C0 + 0x28), 0);
}

void ov45_0222EA2C(int x) {
    if (_022577C0 == NULL) {
        GF_AssertFail();
    }
    ov45_0222F8D8(_022577C0, x);
}
