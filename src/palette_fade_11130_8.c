...
void sub_02011FF8(EffectContext *ctx, const void *config) {
    void *work = Heap_Alloc(ctx->f[8], 0x30);
    ctx->f[5] = (u32)work;
    sub_02012090((void *)ctx->f[5], config, ctx->f[1], ctx->f[2], ctx->f[4], ctx->f[6], ctx->f[7], ctx->f[8]);
    ctx->f[3]++;
}

BOOL sub_02012030(EffectContext *ctx) {
    int result = FALSE;
