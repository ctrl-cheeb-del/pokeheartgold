...
void ov71_022477EC(Ov71Cam *cam, Ov71Vec3 *dst) {
    Ov71Vec3 pos;
    Camera_GetLookAtCamPos(&pos, cam->unk_00);
    *dst = pos;
}

void ov71_0224780C(Ov71Cam *cam, void *arg0) {
    Camera_SetAnglePos(arg0, cam->unk_00);
}

void ov71_0224781C(Ov71Cam *cam, void *arg0) {
    Camera_AdjustAngleTarget(arg0, cam->unk_00);
}

void ov71_0224782C(Ov71Cam *cam, void *arg0) {
    Camera_ApplyPerspectiveType(arg0, cam->unk_00);
}

void ov71_0224783C(Ov71Cam *cam, void *arg0) {
    Camera_SetPerspectiveAngle(arg0, cam->unk_00);
}
