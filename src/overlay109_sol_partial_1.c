...
BOOL PhotoAlbum_Init(OverlayManager *man, int *state) {
    ...
    case 0:
        ov109_021E5A20();
        Heap_Create(HEAP_ID_3, HEAP_ID_96, 0x20000);
        app = OverlayManager_CreateAndGetData(man, sizeof(PhotoAlbumApp), HEAP_ID_96);
        MI_CpuFill8(app, 0, sizeof(PhotoAlbumApp));
        app->heapId = HEAP_ID_96;
...
BOOL PhotoAlbum_Main(OverlayManager *man, int *state) {
    PhotoAlbumApp *app = OverlayManager_GetData(man);
    switch (*state) {
    case 0:
        *state = ov109_021E5BAC(app);
        break;
    case 1:
        *state = ov109_021E5C40(app);
        break;
    case 2:
        *state = ov109_021E5C48(app);
        break;
    case 3:
        *state = ov109_021E5C68(app);
        break;
    case 4:
        *state = ov109_021E5C88(app);
        break;
    case 5:
        *state = ov109_021E5C90(app);
        break;
    case 6:
        *state = ov109_021E5C98(app);
        break;
    case 7:
        *state = ov109_021E5CAC(app);
        break;
    case 8:
        *state = ov109_021E5BF4(app);
        break;
    case 9:
        return TRUE;
    }
