...
void ov75_02246C68(State *p) {
    sub_02031780(*(void **)((u8 *)p + 4), 1, *(u16 *)((u8 *)p + 0x78));
    sub_02031780(*(void **)((u8 *)p + 4), 2, *(u32 *)((u8 *)p + 0x108));
}

void ov75_02246C8C(State *p) {
    sub_02031780(*(void **)((u8 *)p + 4), 3, *(u32 *)((u8 *)p + 0x104));
}

void ov75_02246CA0(State *p) {
    u32 v = sub_0203186C(*(void **)((u8 *)p + 4), (u8 *)p + 0x98);
    ov75_02246CD8(p, v);
}

void ov75_02246CB8(State *p) {
    ov75_02249780(*(void **)((u8 *)p + 0x110), (u8 *)p + 0xbc, 0x73);
}

void ov75_02246CCC(State *p) {
    *(u16 *)((u8 *)p + 0xfa) = *(u32 *)((u8 *)p + 0x108);
}

void ov75_02246CD8(State *p, int v) {
    *(u16 *)((u8 *)p + 0x78) = v;
}

u32 ov75_02246CE0(State *p) {
    return *(u32 *)((u8 *)p + 0x108);
}

u32 ov75_02246CE8(State *p) {
    return *(u32 *)((u8 *)p + 0x104);
}

void ov75_02246CF0(State *p, u8 v) {
    *((u8 *)p + 0x10c) = v;
}

u8 ov75_02246CF8(State *p) {
    return *((u8 *)p + 0x10c);
}
