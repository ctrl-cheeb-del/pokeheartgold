#ifndef GUARD_OVERLAY01_MAP_CHUNK_LOADERS_R6_PRIVATE_H
#define GUARD_OVERLAY01_MAP_CHUNK_LOADERS_R6_PRIVATE_H
...
typedef struct MapLoadChunkSet {
    MapLoadedChunk *chunks[6];
    void *extra[6];
} MapLoadChunkSet;
void ov01_021F4D10(int, void *, void *, int, int, MapLoadManager *, MapLoadChunkSet *);
void ov01_021F5EA0(MapLoadManager *mapLoadManager, int a1, int a2, int a3);
void ov01_021F4E1C(int, void *, void *, int, int, MapLoadManager *, MapLoadChunkSet *);
void ov01_021F5E20(MapLoadManager *mapLoadManager, int a1, int a2, int a3);
void ov01_021F4D88(int, void *, void *, int, int, MapLoadManager *, MapLoadChunkSet *);
void ov01_021F4BE8(MapLoadManager *, MapLoadedChunk *, MapLoadIds *, void *, MapLoadChunkSet *, int, int);
void ov01_021F4AAC(MapLoadManager *, MapLoadedChunk *);
void ov01_021F4AE4(MapLoadManager *, MapLoadedChunk *, int);

#endif // GUARD_OVERLAY01_MAP_CHUNK_LOADERS_R6_PRIVATE_H
