...
void ov83_022475D4(Ov83SpriteWrap *p, int seq) {
    Sprite_SetAnimationFrame(p->sprite, 0);
    Sprite_SetAnimCtrlSeq(p->sprite, seq);
}

void ov83_022475EC(Ov83SpriteWrap *p, int species) {
    int palette = Pokemon_GetIconPalette(species);
    Sprite_SetPalOffsetRespectVramOffset(p->sprite, palette);
}

void ov83_02247600(Ov83SpriteWrap *p, int value) {
    ov80_0222A3D4(p->sprite, value);
}

void ov83_0224760C(Ov83SpriteWrap *p, int value) {
    ov80_0222A400(p->sprite, p->x, p->y, value);
}
