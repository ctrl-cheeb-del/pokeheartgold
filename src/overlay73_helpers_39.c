...
void ov73_021EA2FC(void *p) {
    void *x = sub_020270C4(PTR(p, 4));
    ov73_021E7E24(x, PTR(p, 8), PTR(p, 0xc), PTR(p, 0x10), PTR(p, 0x14));
}

void *ov73_021EA31C(void *p, u32 n) {
    return Save_GetPlayerMixingRankingEntry(p, n);
}
