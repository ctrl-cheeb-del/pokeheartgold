...
void ov85_021E7024(BattleArcadeWork *work) {
    SpriteSystem_FreeResourcesAndManager((SpriteSystem *)work->unk_D94, (SpriteManager *)work->unk_D98);
    SpriteSystem_Free((SpriteSystem *)work->unk_D94);
}

ManagedSprite *ov85_021E7044(BattleArcadeWork *work, const ManagedSpriteTemplate *tmpl) {
    return SpriteSystem_NewSprite((SpriteSystem *)work->unk_D94, (SpriteManager *)work->unk_D98, tmpl);
}
