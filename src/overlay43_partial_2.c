...
void ov43_0222A2F0(u8 *p, u8 *q) {
    TextFlags_SetCanABSpeedUpPrint(FALSE);
    TextFlags_SetCanTouchSpeedUpPrint(FALSE);
    MenuInputStateMgr_SetState(*(void **)(q + 4), *(u32 *)p);
    String_Delete(*(void **)(p + 0x58));
    String_Delete(*(void **)(p + 0x5C));
}

void ov43_0222A318(u8 *p, u8 a, u8 b) {
    p[9] = a;
    p[10] = b;
}
