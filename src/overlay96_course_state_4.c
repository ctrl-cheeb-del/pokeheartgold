...
u32 ov96_021E6BC0(Work*w){((OpsC*)U32(w,0x1e0))->end(w,0);if(U32(w,0x1e4)!=0)GF_AssertFail();PokeathlonCourse_SetStateField07(w,0xb);return 0;}

u32 ov96_021E6BEC(Work*w){U32(w,0x1e0)=(u32)ov96_0221A8E4;U8(w,0x1ed)=0;PokeathlonCourse_InitStateInfo(ov96_0221DA6C,w->d+0x3cc);PokeathlonCourse_SetStateField07(w,0xc);return 0;}

u32 ov96_021E6C20(Work*w){if(PokeathlonCourse_RunSubStateLoop(w)){PokeathlonCourse_SetStateTransitionType(w,7);PokeathlonCourse_SetStateField07(w,0xd);}return 0;}
