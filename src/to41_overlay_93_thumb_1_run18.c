...
u32 ov93_0225E6F8(void *p, void *state) {
    switch (U32AT(state, 0xc)) {
    case 0:
        ov93_02262934(p, U8AT(state, 0x18));
        U32AT(state, 0xc)
        ++;
        break;
    case 1:
        if (ov93_0225E548(p, U8AT(state, 0x18)) == 1) {
            U8AT(state, 0x18)
            ++;
            U32AT(state, 0xc)
            ++;
    ...
    case 3:
        S32AT(state, 0x14)
        ++;
        if (S32AT(state, 0x14) >= 0x5a && ov93_02262748(p) == 1) {
            return 1;
        }
        break;
    }
...
u32 ov93_0225E764(void *p) {
    ...
    if (ov93_02262A20[U32AT(p, 0xb8)](p, st) == 1) {
        U32AT(st, 0)
        ++;
        U32AT(st, 0xc) = 0;
        U32AT(st, 0x14) = 0;
