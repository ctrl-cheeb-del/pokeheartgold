...
void ov34_0225D520(Ov34State *p) {
    void *s = NewString_ReadMsgData(*(void **)((u8 *)p + 0x1C), 0xDB);
    AddTextPrinterParameterizedWithColor((u8 *)p + 0x274, 0, s, 0, 0, 0, 0xF0200, NULL);
    String_Delete(s);
}

void ov34_0225D558(Ov34State *p) {
    if ((*(u32 *)(gSystem + 0x48) & 0x400) && ov01_021F6B10(*(void **)((u8 *)p + 0xC)) == 1) {
        *(u32 *)p = 3;
    }
    ov34_0225E58C(p);
    ov34_0225E4F8(p);
