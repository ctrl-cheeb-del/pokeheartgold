...
void ov83_02247B04(void *p) {
    int value = GridInputHandler_GetNextInput(p);
    GridInputHandler_SetNextLastUnk0FInputs(p, 0, value, value);
}

void ov83_02247B1C(void *p, int a, int b) {
    ov83_02242AB4(p, ov83_02248544[a], ov83_02248544[b]);
}
...
void ov83_02247B4C(void *p, int a, int b) {
    ov83_022469D8(p, ov83_02248544[a], ov83_02248544[b]);
}
