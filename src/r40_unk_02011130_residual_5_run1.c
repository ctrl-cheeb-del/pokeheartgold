#include "r40_unk_02011130_residual_5_private.h"

void sub_02011BF0(LocalFadeEffect *work, const LocalFadeParam *param, u32 repeats, u32 delay, u32 screen, u32 arg5, u32 arg6, u32 heapId) {
    s16 *buffer;

    work->step = sub_02010A6C(param->start, param->end, repeats);
