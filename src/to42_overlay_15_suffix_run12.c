...
void ov15_021FFFDC(BagWorkRaw *work, s32 index) {
    GF_ASSERT(index < 8);
    index <<= 2;
    ManagedSprite_SetPositionXYWithSubscreenOffset(*(ManagedSprite **)&work->raw[0x2A0], ov15_022009D4[index], ov15_022009D5[index], 1 << 20);
    ManagedSprite_SetAnim(*(ManagedSprite **)&work->raw[0x2A0], ov15_022009D6[index]);
    ManagedSprite_SetPaletteOverride(*(ManagedSprite **)&work->raw[0x2A0], ov15_022009D7[index]);
}
