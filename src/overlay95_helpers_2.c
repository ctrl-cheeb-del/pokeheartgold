...
void ov95_021E5B24(State *p) {
    volatile u32 *a = (volatile u32 *)0x027e0000;
    PokepicManager_HandleLoadImgAndOrPltt(*(void **)((u8 *)p + 0x3c));
    GF_RunVramTransferTasks();
    SpriteSystem_TransferOam();
    PaletteData_PushTransparentBuffers(*(void **)((u8 *)p + 8));
...
void ov95_021E5B7C(void) {
    BeginNormalPaletteFade(0, 1, 1, 0, 6, 1, 0x46);
}

void ov95_021E5B9C(void) {
    BeginNormalPaletteFade(0, 0, 0, 0, 6, 1, 0x46);
}
