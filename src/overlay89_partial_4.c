...
void ov89_02259E10(void *p) {
    GF_3DVramMan_Delete(p);
}

void ov89_02259E18(u8 *p) {
    *(void **)(p + 0x16C) = ov45_0222E9E0(p);
}

void ov89_02259E28(void *unused, u8 *p) {
    MI_CpuFill8(p, 0, 12);
    *(u16 *)(p + 2) = 150;
    *(u16 *)p = 31;
    *(u32 *)(p + 4) = 257;
